...
const Header = () => {
  ...
  const dienthoaiMenuItems = [
    { text: "Xiaomi", href: "/dienthoai?brand=xiaomi" },
    { text: "OPPO", href: "/dienthoai?brand=oppo" },
    { text: "Vivo", href: "/dienthoai?brand=vivo" },
    { text: "Realme", href: "/dienthoai?brand=realme" },
    { text: "OnePlus", href: "/dienthoai?brand=oneplus" },
    { text: "Samsung Galaxy", href: "/dienthoai?brand=samsung" },
  ];

  const tabletMenuItems = [
    { text: "Xiaomi Pad", href: "/may-tinh-bang?brand=xiaomi" },
    { text: "Redmi Pad", href: "/may-tinh-bang?brand=redmi" },
    { text: "POCO Pad", href: "/may-tinh-bang?brand=poco" },
    { text: "Vivo Pad", href: "/may-tinh-bang?brand=vivo" },
    { text: "iQOO Pad", href: "/may-tinh-bang?brand=iqoo" },
    { text: "OPPO Pad", href: "/may-tinh-bang?brand=oppo" },
    { text: "OnePlus Pad", href: "/may-tinh-bang?brand=oneplus" },
  ];

  const smartwatchMenuItems = [
    { text: "Xiaomi Watch", href: "/dong-ho-thong-minh?brand=xiaomi" },
    { text: "Redmi Watch", href: "/dong-ho-thong-minh?brand=redmi" },
    { text: "POCO Watch", href: "/dong-ho-thong-minh?brand=poco" },
    { text: "Vivo Watch", href: "/dong-ho-thong-minh?brand=vivo" },
    { text: "OPPO Watch", href: "/dong-ho-thong-minh?brand=oppo" },
    { text: "OnePlus Watch", href: "/dong-ho-thong-minh?brand=oneplus" },
    { text: "Samsung Galaxy Watch", href: "/dong-ho-thong-minh?brand=samsung" },
  ];

  const phukienMenuItems = [
    { text: "Âm Thanh", href: "/phu-kien?cat=4" },
    { text: "Sạc & Nguồn", href: "/phu-kien?cat=5" },
    { text: "Phụ Kiện Điện Thoại", href: "/phu-kien?cat=6" },
    { text: "Thiết Bị Nhập Liệu", href: "/phu-kien?cat=7" },
    { text: "Phụ Kiện Quay Chụp", href: "/phu-kien?cat=8" },
    { text: "Thiết Bị Lưu Trữ", href: "/phu-kien?cat=9" },
    { text: "Smarthome", href: "/phu-kien?cat=10" },
    { text: "Phụ Kiện Khác", href: "/phu-kien?cat=11" },
  ];
